...
brandAddressRouter.put('/:id', isAuth, isSeller,isAdmin,isSellerOrAdmin, expressAsyncHandler(async(req, res) => {
...
brandAddressRouter.delete("/:id",expressAsyncHandler(async (req, res) => {
  ...
  if (deleteBrandAddress) {
    ...
    res.send({ message: "Brand Deleted", deleteBrandAddress: brandAddressDeleted });
  } else {
